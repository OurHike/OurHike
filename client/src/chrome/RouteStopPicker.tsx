...
import { searchPois } from '../lib/searchPoi'
...
export function RouteStopPicker({
  ...
  const results = searchPois(query, [...choices]) as RouteStopChoice[]
    ...
    <div className="stop-picker" role="dialog" aria-label="Choose a stop">
      <div className="stop-picker__bar">
        ...
        <input
          ...
          autoFocus
          value={query}
          placeholder="Search shelters, towns, campsites"
