...
function App() {
  ...
  /** Whether the junction card (frame `D10`) is open over the next-turn
   *  card. Closed on its own × and whenever following stops. */
  ...
  const followSheetNode = (() => {
    if (followingHike === null || followState === null) return null
