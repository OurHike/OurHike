...
**The client half landed first.** No exporter writes the artifact; where published routes come from — a club's own GPX, a guidebook's tables, a hiker's saved day hike shared out — is a decision nobody has made. Until then a release has no shelf and no section, which is a phone with nothing to suggest rather than a failed download. The document shape is:
