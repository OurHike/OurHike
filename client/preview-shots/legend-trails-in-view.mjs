...
// "Blaze colors" switch directly above the block below - unchecked here, the
// shipped default - yet the rows' swatches are still white and blue. That is
