...
// and below z11 the band steps to a half-scale rhythm
// (CLOSURE_OVERVIEW_DASH), so a closure shorter than the navigation band's
// pitch still carries a tick instead of landing between two and drawing as a
// blank slab of the sheet's paper. z11 is where the
