...
- **The backend is picked and costed** in [backend/HOSTING.md](backend/HOSTING.md) - Fly.io, ~$2/month, chosen over Cloudflare Containers, Render, Railway, Cloud Run and a bare VPS on cost and configuration weight.
