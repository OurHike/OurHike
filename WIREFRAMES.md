...
- **Safety & privacy** — **Use my location** (added 2026-08-07, [#312](https://github.com/OurHike/OurHike/issues/312) — the section's one live switch), wrong-way alert toggle, "hide my name on reports for…" *(Later)*, and a red locked callout: **closures and serious warnings are always shown; there is no switch, here or anywhere.**
