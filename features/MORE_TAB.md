...
| **Safety & Privacy** | Safety & privacy | Kept alone deliberately, not folded into Map & Display. [CLAUDE.md](../CLAUDE.md) names four ways this app can hurt somebody, and the location toggle is one of the controls that answers them — a control worth finding quickly should not share a tab with detail-level radio buttons. (The wrong-way alert was the other, before its removal — #93/#308.) |
